//Topic Endpoint: https://acg-eg-kabelomogapi.northeurope-1.eventgrid.azure.net/api/events
...
function publishToEventGrid(speaker) {
  ...
  const topicHostName =
    "https://acg-eg-kabelomogapi.northeurope-1.eventgrid.azure.net/api/events";
  let data = speaker;
  let events = [
    {
      id: uuid(),
